let metaddr = {  
  metmarket: "0x9196D43eCa46ba83B161B11df57b05f58Cc9079E" //tiger
...
let metabi = {
  ...
  metmarket: [
     ...
     "function metainfo(uint _num) public view returns (uint256, uint256, string memory, uint256,uint8,address) ",
    ],
...
try {
    ...
    return {
        info0: metaInfo[0], // id
        info1: metaInfo[1], // metanum
        info2: metaInfo[2], // investor
        info3: metaInfo[3], // init
        info4: metaInfo[4], // trade
        info5: metaInfo[5], // owner
      ...
      if (metaInfo) {
          ...
          switch (metaInfo.info4) {
            ...
            <div class="card-body">
                ...
                <p class="card-text"><strong>Account:</strong> ${metaInfo.info1}</p>
                <p class="card-text"><strong>Viewer Password:</strong> ${metaInfo.info2}</p>
                <p class="card-text"><strong>Price:</strong> ${metaInfo.info3/1e18} p</p>
                <p class="card-text"><strong>Purchasable:</strong> ${isPurchasable}</p>
                <p class="card-text"><strong>Account Holder:</strong> ${metaInfo.info5}</p>
